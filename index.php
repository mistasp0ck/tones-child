				...
				<div id="main" class="col-sm-8 clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
							...
							<p class="meta"><span class="time"></span> <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php echo get_the_date('F jS, Y', '','', FALSE); ?></time></a>  <span class="cat"></span> <?php the_category(', '); ?></p>
